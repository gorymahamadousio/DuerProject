        ...
        <div class="container">
            ...
            <input type="hidden" name="mode" value="2">
                ...
                <table border=1 width="80%" align="center">
                    <tr>
                        <td align="center" colspan="5"><b>Les informations sur les solutions</b></td>
                    </tr>
                    ...
                    <?php
                        ...
                        if($nb > 0) 
                        {
                            ...
                            while ($i<$nb)
                            {
                                ...
                                echo "<tr><td><input type='checkbox' name='solution[]' value='$num'></td>";
                                echo "<td>$num</td>";
                                echo "<td>$complexite</td>";
                                echo "<td>$onereuse</td>";
                                echo "<td><a href='vue_resolution_de_la_situation_modif.php?action=$num'><input type='button' value='Modifier'></a></td>";
                                echo "</tr>";
                                $i=$i+1;
                            }
                        }	
