...
<html lang="en">
    ...
    <body style="background-color: white;">
        <div class="container">
            ...
            <div class="row bg-sombre text-white fw-bolder justify-content-center align-intems-center">
                <div class="row p-3 mb-2 text-white fw-bolder placeholder-glow">      
                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                      ...
                      <a class="btn btn-dark" href="vue_personne_exposées.php" role="button">Personne exposées</a>
            ...
            <div class="base-form">
                <div class="titre-1"><p><h3>Formulaire D.U.E.R lycées voillaume</h3></p></div><br>
