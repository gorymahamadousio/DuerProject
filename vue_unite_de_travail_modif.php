    ...
    <body style="background-color: white;">
        <div class="container">
            ...
            <form action="controleur_modif.php" method="post">
                ...
                <label for="Id_Unite_de_travail">Num</label>
                <input type='text' name="Id_Unite_de_travail" id="Id_Unite_de_travail" value="<?=$unite_de_travail['Id_Unite_de_travail']?>"  readonly="readonly">
                <label for="salle">Salle</label>
                <input type="text" name="salle" id="salle" value="<?=$unite_de_travail['salle']?>">	
