    ...
    <body style="background-color: white;">
        <div class="container">
            ...
            <form action="controleur_modif.php" method="post">
                ...
                <label for="Id_solution_de_la_situation">Num</label>
                <input type='text' name="Id_solution_de_la_situation" id="Id_solution_de_la_situation" value="<?=$solution['Id_solution_de_la_situation']?>"  readonly="readonly">
                <label for="complexite_de_resolution">Complexite</label>
                <input type="text" name="complexite_de_resolution" id="complexite_de_resolution" value="<?=$solution['complexite_de_resolution']?>">
                <label for="solution_onereuse">Onereux</label>
                <input type="text" name="solution_onereuse" id="solution_onereuse" value="<?=$solution['solution_onereuse']?>">	
