            ...
            <input type="hidden" name="mode" value="5">
                ...
                <table border=1 width="80%" align="center">
                    ...
                    <tr  style='border-bottom:1pt solid black;'>
                        <th>#</th>    
                        <th>Num</th>
                        <th width="20%">Blessures graves ou deces</th>
                        <th width="20%">Maladie mortelle</th>
                        <th width="20%">Penebilite physique</th>
                        <th width="20%">Penebilite mentale</th>
                    ...
                    <?php
                        ...
                        if($nb > 0) 
                        {
                            ...
                            while ($i<$nb)
                            {
                                ...
                                echo "<tr><td><input type='checkbox' name='gravite[]' value='$num'></td>";
                                echo "<td>$num</td>";
                                echo "<td>$b_graves</td>";
                                echo "<td>$m_mortelle</td>";
                                echo "<td>$p_physique</td>";
                                echo "<td>$p_mentale</td>";
                                echo "<td><a href='vue_gravite_modif.php?action=$num'><input type='button' value='Modifier'></a></td>";
                                echo "</tr>";
                                $i=$i+1;
                            }
                        }	
